  ...
  useEffect(() => {
    let ctx = gsap.context(() => {
      ...
      gsap
        ...
        .from(asset, { stagger: 0.05, duration: 0.2, opacity: 0 })
        .to(
          lampLight,
          { duration: 0.1, opacity: 0.8, ease: 'elastic', delay: 0.5 },
          'a'
        )
        .to(lampLight, { duration: 0.1, opacity: 0 }, 'b')
        .to(lampLight, { furation: 0.1, opacity: 0.2 }, 'c')
        .fromTo(
          lampLine,
          { opacity: 0 },
          { duration: 0.2, opacity: 0.1, delay: 0.5 },
          'a-=0.05'
        )
    ...
    <>
      <div className="container contact-page">
        ...
        <div className="map-wrap">
          <MapContainer center={[25.340666, 83.0469]} zoom={14}>
            <TileLayer
              attribution='&copy; <a href="https://www.openstreetmap.org/copyright">OpenStreetMap</a> contributors'
              url="https://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png"
              id="mapbox/dark-v10"
            />
            <Marker position={[25.340666, 83.0469]}>
              <Popup>
                Hello There, <br /> I live here, come over for a cup of coffee
                :).
              </Popup>
            </Marker>
          </MapContainer>
        ...
        >
          <g id="background">
            <rect x="-9.7" y="0" fill="#2b2d42" width="1197.1" height="662.8" />
          </g>
          <g id="table_legs">
            <g>
              <defs>
              ...
              />
              <path
                style={{ clipPath: 'url(#SVGID_2_)', fill: '#FFCF0A' }}
                d="M273.8,586.3"
              />
            </g>
          </g>
